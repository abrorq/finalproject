...
class BedClothesController {
    private final List<Product> inventory;
    private final Scanner scanner;

    public BedClothesController(List<Product> inventory, Scanner scanner) {
...
class DishesController {
    ...
    public DishesController(List<Product> inventory, Scanner scanner) {
        this.inventory = inventory;
        this.scanner = scanner;
    }
...
class FilterController {
    ...
    public FilterController(List<Product> inventory, Scanner scanner) {
        this.inventory = inventory;
        this.scanner = scanner;
    }
...
public class WarehouseApplication2 {
    private final List<Product> inventory;
    private final Scanner scanner;

    public WarehouseApplication2() {
    ...
    public void run() {
        ...
        do {
            ...
            switch (choice) {
                case "1" -> new BedClothesController(inventory, scanner).searchProducts();
                case "2" -> new DishesController(inventory, scanner).searchProducts();
                case "3" -> listAllProducts();
                case "4" -> new FilterController(inventory, scanner).filterByPrice();
    ...
    public static void main(String[] args) {
        WarehouseApplication2 application = new WarehouseApplication2();
        application.run();
    }
}